...
| **AUTH**                              |                                                                                                                                                                                                                                |                  |        |
| T31                                   | Navbar "Sign in" button triggers Supabase Google OAuth flow                                                                                                                                                                    | Person B         | CODE DONE (waiting on Google OAuth secret in Supabase) |
| T32                                   | Auth callback: if localStorage has `session_id`, call `POST /api/pets/[id]/claim`, clear `session_id`, redirect to `/pet/[id]`                                                                                                 | Person B         | CODE DONE (waiting on Google OAuth secret in Supabase) |
| **ASSETS**                            |                                                                                                                                                                                                                                |                  |        |
